  ...
  return (
    <div className="max-w-xl mx-auto px-8 py-24">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="space-y-12">
        ...
        <select className="appearance-none border-b border-black pb-3 mb-10 text-lg focus:outline-none w-full bg-transparent">
        ...
        <textarea
          placeholder="Message"
          rows={6}
          className="border-b border-black pb-3 text-lg focus:outline-none w-full resize-y placeholder:text-neutral-400"
        />
